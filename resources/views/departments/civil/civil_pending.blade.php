        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/pending-civil-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <select name="project_department" required class="form-control" id="inlineFormInputGroupUsername2">
                        ...
                        <option value="">--Change Civil Works Status--</option>
                        <option value="Civil Works Pending Project" selected>Civil Works Pending Project</option>
                        <option value="Civil Works Completed Project">Civil Works Completed Project</option>
                        <option value="Civil Works Backup">Backup</option>
                      </select>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pending Projects ({{$civilcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Civil Works projects waiting to be worked on</p>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        @foreach($civilprojects as $project)
                        <tr>
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-civil-pending/'.$project->id)}}" method="POST">
                              @csrf
                            ...
                            <option value="Completed Project">Completed Project</option>
                            <option value="">--Change Civil Works Status--</option>
                            <option value="Civil Works Pending Project">Civil Works Pending Project</option>
                            <option value="Civil Works Completed Project">Civil Works Completed Project</option>
                            <option value="Civil Works Backup">Backup</option>
                            </select>
                          </td>
