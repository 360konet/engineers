        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/share-architect-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Shared Projects ({{$arcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-architect-share/'.$project->id)}}" method="POST">
                              @csrf
