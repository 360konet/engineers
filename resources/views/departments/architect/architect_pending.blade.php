        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/pending-architect-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <select name="project_department" required class="form-control" id="inlineFormInputGroupUsername2">
                        ...
                        <option value="Architect Pending Project" selected>Architect Pending Project</option>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pending Projects ({{$arcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-architect-pending/'.$project->id)}}" method="POST">
                              @csrf
