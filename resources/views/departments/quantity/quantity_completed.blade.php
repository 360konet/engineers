            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/completed-quantity-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-quantity-completed/'.$project->id)}}" method="POST">
                              @csrf
