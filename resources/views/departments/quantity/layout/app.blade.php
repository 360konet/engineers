  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity')}}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity-share')}}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity-pending')}}">
            <i class="mdi mdi-book menu-icon"></i>
            <span class="menu-title">Pending Projects</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity-completed')}}">
            <i class="mdi mdi-book menu-icon"></i>
            <span class="menu-title">Completed Projects</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity-backup')}}">
            <i class="mdi mdi-book menu-icon"></i>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/quantity-part1')}}">
          <i class="mdi mdi-book menu-icon"></i>
