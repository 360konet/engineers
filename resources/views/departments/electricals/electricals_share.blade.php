        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Project Share Portal</h4>
                  <p class="card-description">Welcome to the projects share portal to register new projects and share projects to various departments</p>
                  <form class="form-inline" action="{{url('/share-electricals-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Shared Projects ({{$electcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-electricals-share/'.$project->id)}}" method="POST">
                              @csrf
