        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/backup-electricals-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <select name="project_department" readonly required class="form-control" id="inlineFormInputGroupUsername2">
                         <option value="Electricals Backup" selected>Backup</option>
                      </select>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Backed Up Projects ({{$electcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
