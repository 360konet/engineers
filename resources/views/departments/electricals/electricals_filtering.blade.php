            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">Welcome to the filteration portal to sort out electricals projects</p>
                  <form class="form-inline" action="{{url('/filter-projects')}}" method="POST" enctype="multipart/form-data">
                   ...
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <input type="date" name="start_date" required class="form-control" id="inlineFormInputGroupUsername2" placeholder="Select date">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">End Date</div>
                      </div>
                      <input type="date" name="end_date" required class="form-control" id="inlineFormInputGroupUsername2" placeholder="Select date">
                    </div>
                    <button type="submit" class="btn btn-primary mb-2">Filter Projects</button>
                  </form>
                </div>
              </div>
            </div>
