@include('departments.electricals.layout.app')
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Projects Completed</h4>
                  <p class="card-description">Welcome to the completed projects portal</p>
                  <form class="form-inline" action="{{url('/completed-electricals-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <select name="project_department" required class="form-control" id="inlineFormInputGroupUsername2">
                        ...
                        <option value="Electricals Pending Project">Electricals Pending Project</option>
                        <option value="Electricals Completed Project" selected>Electricals Completed Project</option>
                        <option value="Electricals Backup">Backup</option>
                      </select>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Completed Projects ({{$electcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Completed electricals projects </p>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        @foreach($electprojects as $project)
                        <tr>
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-electricals-completed/'.$project->id)}}" method="POST">
                              @csrf
                            ...
                            <option value="">--Change Electricals Status--</option>
                            <option value="Electricals Pending Project">Electricals Pending Project</option>
                            <option value="Electricals Completed Project">Electricals Completed Project</option>
                            <option value="Electricals Backup">Backup</option>
                            </select>
                          </td>
