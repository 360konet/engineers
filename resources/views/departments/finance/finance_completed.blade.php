        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" action="{{url('/completed-finances-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <select name="project_department" required class="form-control" id="inlineFormInputGroupUsername2">
                        ...
                        <option value="Finance Completed Project" selected>Finance Completed Project</option>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Completed Projects ({{$fcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Completed finance projects </p>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-architect-completed/'.$project->id)}}" method="POST">
                              @csrf
                            ...
                            <option value="">--Change Finance Status--</option>
                            <option value="Finance Pending Project">Finance Pending Project</option>
                            <option value="Finance Completed Project">Financet Completed Project</option>
                            <option value="Finance Backup">Backup</option>
                            </select>
                          </td>
