@include('departments.orderly.layout.app')
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Project Pending</h4>
                  <p class="card-description">Welcome to the pending project portal</p>
                  <form class="form-inline" action="{{url('/pending-orderly-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Project Name</label>
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">Departments</div>
                      </div>
                      <select name="project_department" required class="form-control" id="inlineFormInputGroupUsername2">
                        ...
                        <option value="">--Change Orderly Room Status--</option>
                        <option value="Orderly Room Pending Project" selected>Orderly Room Pending Project</option>
                        <option value="Orderly Room Completed Project">Orderly Room Completed Project</option>
                        <option value="Orderly Room Backup">Backup</option>
                      </select>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                    ...
                    <button type="submit" class="btn btn-primary mb-2">Upload Project</button>
                  </form>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pending Projects ({{$ocount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Orderly Room projects waiting to be worked on</p>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/forward-orderly-pending/'.$project->id)}}" method="POST">
                              @csrf
                            ...
                            <option value="Pending Project">Pending Project</option>
                            <option value="Completed Project">Completed Project</option>
                            <option value="">--Change Electricals Status--</option>
                            <option value="Orderly Room Pending Project">Orderly Room Pending Project</option>
                            <option value="Orderly Room Completed Project">Orderly Room Completed Project</option>
                            <option value="Orderly Room Backup">Backup</option>
                            </select>
                          </td>
