      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Part 1 Portal</h4>
                  <p class="card-description">Welcome to the part 1 projects portal</p>
                  <form class="form-inline" action="{{url('/orderly-part1-submit')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                   <label class="sr-only" for="inlineFormInputGroupUsername2">Title</label>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">Title</div>
                      </div>
                      <input name="title" required class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter Title">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">Publisher</div>
                      </div>
                      <input name="publisher" required class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter Publisher">
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">File</div>
                      </div>
                      <input class="form-control" required name="file" type="file" placeholder="Enter Project file">
                    </div>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      @foreach($part1 as $part1)
                        <tr>
                        <td class="py-1">
                            @if($part1->file)
                            <a href="{{ asset('part1/' . $part1->file) }}" target="_blank">{{$part1->file}}</a>
                            @else
                                No file
                            @endif
                        </td>
