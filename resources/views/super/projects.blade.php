        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Projects Portal</h4>
                  <p class="card-description">Welcome to the projects portal to register new projects and assign projects to departments</p>
                  <form class="form-inline" action="{{url('/add-project')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pending Projects ({{$pcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
