        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Finance ({{$fcount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Financial statements</p>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/finance-forward/'.$project->id)}}" method="POST">
                              @csrf
