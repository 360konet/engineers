        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Orderly Room Operations ({{$ocount}})<input type="text"  style="float:right" id="searchInput" placeholder="Search projects..."></h4>
                  <p class="card-description">Oderly room operations/works being worked on</p>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td class="py-1">
                          ...
                          <td>
                          <form action="{{url('/orderly-forward/'.$project->id)}}" method="POST">
                              @csrf
                          ...
                          <td><button type="submit" class="btn btn-primary mb-2">Forward</button></p></td>
                         </form>
                        </tr>
                        @endforeach
                      </tbody>
