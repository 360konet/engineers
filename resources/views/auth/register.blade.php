               ...
               @csrf
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="name" required class="form-control form-control-lg border-left-0" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <label>Phone</label>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="svc" required class="form-control form-control-lg border-left-0" placeholder="Service Number">
                  </div>
                </div>
                <div class="form-group">
                  <label>Email</label>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" name="password_confirmation" required class="form-control form-control-lg border-left-0" id="exampleInputPassword" placeholder="Confirm Password">                        
                  </div>
                </div>
                <div class="mt-3">
                    <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="submit">Register</button>
                </div>
