              ...
              <form class="pt-3" method="POST" action="{{ route('login') }}">
               @csrf
                <div class="form-group">
                  <label for="exampleInputEmail">Svc #</label>
                  <div class="input-group">
                    ...
                    <input type="text" required name="svc" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="Service Number">                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="my-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="submit">Login</button>
                </div>
